...
我们用来检查和衡量用户满意度的工具称为**用户旅程**。用户旅程是以文本形式编写的陈述，用来描述用户的视角。用户旅程探讨了：用户如何与服务互动的过程，以自己想要实现目标。那些最重要的用户旅程被称为**关键用户旅程** (CUJ)。[^4]
...
![图 4-1. 中断生命周期](2024-06-30_10-36-16.png)
...
![不可用性公式](2024-06-30_10-36-34.png)
...
![图 4-2. 中断生命周期：检测时间](2024-06-30_10-36-52.png)
...
![图 4-3. 中断生命周期：修复时间](2024-06-30_10-37-12.png)
...
![图 4-4. 一个 ICS 层次结构示例](2024-06-30_10-37-33.png)
...
![图 4-5. 中断生命周期：故障间隔时间](2024-06-30_10-38-00.png)
